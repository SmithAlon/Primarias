...
const RegistroInst = ({ onNext, onBack }) => {
        ...
        <div className="flex flex-col items-center justify-center w-full">
            <div className="w-full max-w-md bg-gray-200 rounded-md shadow-md p-6">
                <div className="flex items-center justify-between mb-4">
                    <button className="text-xs" onClick={onBack}>❌Cancelar</button>
                    <h1 className="text-center text-2xl font-semibold flex-1">Institución</h1>
                </div>
